...
function shouldBehaveLikeAsset721(
  errorPrefix,
  owner,
  approved,
  anotherApproved,
  ...
  context('with minted tokens', function () {
    ...
    describe('transfersItem', function () {
      ...
      beforeEach(async function () {
        ...
        await this.token.methods['setApprovalForAll(uint256,address,bool)'](
          ownerId,
          operator,
          true,
          {
      ...
      const shouldTransferTokensByUsers = function (transferFunction) {
        ...
        context(
          'when the address to transfer the token to is the id  not exist',
          function () {
            it('reverts', async function () {
              await expectRevert(
      ...
      describe('via safeTransferFromItem', function () {
        const safeTransferFromItemWithData = function (
          senderId,
          fromId,
          toId,
          tokenId,
        ...
        describe('to a receiver contract returning unexpected value', function () {
          it('reverts', async function () {
            ...
            await expectRevert(
              this.token.methods[
                'safeTransferFrom(uint256,uint256,uint256,bytes)'
              ](ownerId, invalidReceiverId, tokenId, '0x', {
                from: owner,
              }),
        ...
        describe('to a receiver contract that reverts with message', function () {
          it('reverts', async function () {
            ...
            await expectRevert(
              this.token.methods[
                'safeTransferFrom(uint256,uint256,uint256,bytes)'
              ](ownerId, revertingReceiverId, tokenId, '0x', {
                from: owner,
              }),
        ...
        describe('to a contract that does not implement the required function', function () {
          it('reverts', async function () {
            ...
            await expectRevert(
              this.token.methods[
                'safeTransferFrom(uint256,uint256,uint256,bytes)'
              ](ownerId, nonReceiverId, tokenId, '0x', {
                from: owner,
              }),
              'Asset721: transfer to non ERC721Receiver implementer',
            );
    ...
    describe('setApprovalForAllItem', function () {
            ...
            function () {
              it('approves the operator', async function () {
                await this.token.methods[
                  'setApprovalForAll(uint256,address,bool)'
                ](ownerId, operator, true, {
                  from: owner,
                });
              ...
              it('emits an approvalById event', async function () {
                const { logs } = await this.token.methods[
                  'setApprovalForAll(uint256,address,bool)'
                ](ownerId, operator, true, {
                  from: owner,
                });
      ...
      context('when the operator is the owner', function () {
        it('reverts', async function () {
          await expectRevert(
            this.token.methods['setApprovalForAll(uint256,address,bool)'](
              ownerId,
              owner,
              true,
              {
    ...
    context('with minted tokens', function () {
      ...
      context('with burnt token', function () {
        ...
        it('deletes the token', async function () {
          ...
          await expectRevert(
            this.token.ownerAccountOf(firstTokenId),
            'Asset721: owner query for nonexistent token',
          );
        });
  ...
  describe('isTrust safe conract and trust world', function () {
    ...
    shouldBehaveLikeAsset721IsTrust(
      owner,
      approved,
      operator,
      other,
...
function shouldBehaveLikeAsset721IsTrust(
  owner,
  approved,
  operator,
  other,
  ...
  describe('safeTransferFrom', function () {
    it('emit Transfer event', async function () {
      ...
      const receipt = await safeTransferFromWithData.call(
        this,
        owner,
        this.receiver.address,
        tokenId,
  ...
  describe('safeTransferFromItem', function () {
    it('emit TransferItem event', async function () {
      ...
      const receipt = await safeTransferFromItemWithData.call(
        this,
        ownerId,
        this.receiverId,
        tokenId,
