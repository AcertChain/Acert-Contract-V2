...
//           await expectRevert(
//             this.token.balanceOf(ZERO_ADDRESS), 'I06',
//           );
//         });
//       });
//     });
...
//           await expectRevert(
//             this.token.ownerOf(tokenId), 'I08',
//           );
//         });
//       });
//     });
...
//         it('reverts', async function () {
//           await expectRevert(
//             this.token.approve(owner, tokenId, { from: owner }), 'I09',
//           );
//         });
//       });
...
//           it('throws', async function () {
//             await expectRevert(
//               this.token.balanceOfById(0), 'I07',
//             );
//           });
//         });
//       });
...
//           it('reverts', async function () {
//             await expectRevert(
//               this.token.ownerOfById(tokenId), 'I08',
//             );
//           });
//         });
//       });
...
//           it('reverts', async function () {
//             await expectRevert(
//               this.token.approveById(ownerId, tokenId, { from: owner }), 'I09',
//             );
//           });
//         });
...
//             expect(await this.token.balanceOfById(ownerId)).to.be.bignumber.equal('1');
//             await expectRevert(
//               this.token.ownerOfById(firstTokenId), 'I08',
//             );
//           });
