...
contract('Miner', function (accounts) {
    ...
    it('mint token', async function () {
        ...
        await this.miner.call(this.token.address, abiEncodedCall, { from: this.minerA });
        expect(await this.token.totalSupply()).to.be.bignumber.equal(initialSupply);
        expect(await this.token.methods['balanceOf(address)'](this.minerA)).to.be.bignumber.equal(initialSupply);
