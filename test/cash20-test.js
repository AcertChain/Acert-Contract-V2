...
contract('Cash20', function (accounts) {
    ...
    beforeEach(async function () {
        ...
        console.log("World deployed to:", this.world.address);
    ...
    describe('decrease allowance', function () {
            ...
            describe('when there was no approved amount before', function () {
              it('reverts', async function () {
                await expectRevert(this.token.decreaseAllowance(
                  spender, amount, { from: initialHolder }), 'Cash: decreased allowance below zero',
                );
              });
            });
      ...
      describe('increase allowance', function () {
        ...
        describe('when the spender is the zero address', function () {
          ...
          it('reverts', async function () {
            await expectRevert(
              this.token.increaseAllowance(spender, amount, { from: initialHolder }), 'Cash: approve to the zero address',
            );
          });
        });
      });
      ...
      describe('_transfer', function () {
        ...
        //       'Cash: transfer from the zero address',
        //     );
        //   });
        // });
      });
      ...
      describe('_approve', function () {
        ...
        //       'Cash: approve from the zero address',
        //     );
        //   });
        // });
      });
