...
contract('Cash20', function (accounts) {
  ...
  it(`checkout account id`, async function () {
    ...
    expect(await this.world.getAccountIdByAddress(this.BWOInitialHolder)).to.be.bignumber.equal(BWOfromId);
  });
  ...
  shouldBehaveLikeCash20BWO('Cash', initialSupply, this.BWOInitialHolder, BWOfromId, recipient, recipientId, anotherAccount, anotherAccountId);
