...
function shouldBehaveLikeAsset20BWO(
  errorPrefix,
  initialSupply,
  initialHolder,
  initialHolderId,
...
function shouldBehaveLikeAsset20TransferBWO(
  errorPrefix,
  spender,
  from,
  to,
  ...
  describe('when the recipientId is not the zero id', function () {
    describe('when the sender does not have enough balance', function () {
      ...
      it('reverts', async function () {
        ...
        await expectRevert(
          transfer.call(this, spender, from, to, amount, nonce, key),
...
function shouldBehaveLikeAsset20ApproveBWO(
  errorPrefix,
  owner,
  ownerAddr,
  spenderAddr,
  ...
  describe('when the spender is the zero address', function () {
    it('reverts', async function () {
      const nonce = await this.token.getNonce(ownerAddr);
      await expectRevert(
        approve.call(this, owner, ownerAddr, ZERO_ADDRESS, supply, nonce, key),
