...
contract('Asset20', function (accounts) {
  ...
  shouldBehaveLikeAsset20ProxyBWO('Asset20', initialSupply, BWOInitialHolder, BWOfromId, BWOReceipt, BWOToId, anotherAccount, anotherAccountId, BWOkey, BWOReceiptkey);
